...
var calcRectPerim = function ()
{
    var floatRectWidth = parseFloat($("rect_width").value);
    var floatRectHeight = parseFloat($("rect_height").value);
    alert ("The rectangle perimeter is " + rectPerim(floatRectWidth, floatRectHeight)); //calls the function in the alert
};
...
var calcTriangleArea = function ()
{
    ...
    alert ("The area of the triangle is " + triangleArea(floatTriSide1, floatTriSide2, floatTriSide3, floatS));
};

function triangleArea(floatTriSide1_par, floatTriSide2_par, floatTriSide3_par, floatS_par)
{
    floatTriangleArea = Math.sqrt((floatS_par*(floatS_par-floatTriSide1_par)*(floatS_par-floatTriSide2_par)*(floatS_par-floatTriSide3_par)));
...
//    $("radius").value = "";
    ...
    $("calc_rect_area").onclick = calcRectArea; // This run the calcRectArea function when clicked

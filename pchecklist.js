...
var passwordCheckOld = function () 
{
 ...
 if (stringPassword.length < 8)
   {
      stringOutput = "Try again. You are " + (8 - stringPassword.length) + " characters shy."; //Error message for a password that is too short. 
   }
   else
   {
     for (var i=0; i<arrayBadPasswords.length; i++)
     {
      ...
      {
        stringOutput = "Password is too predictable.";
      }      
     } 
   }
 if (stringPassword >= 8 && stringPassword != arrayBadPasswords)
 {
